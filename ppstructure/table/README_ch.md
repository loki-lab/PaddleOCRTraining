...
文本检测模型的训练、评估和推理流程可参考 [detection](../../PaddleOCR/doc/doc_ch/detection.md)

文本识别模型的训练、评估和推理流程可参考 [recognition](../../PaddleOCR/doc/doc_ch/recognition.md)

表格识别模型的训练、评估和推理流程可参考 [table_recognition](../../PaddleOCR/doc/doc_ch/table_recognition.md)
