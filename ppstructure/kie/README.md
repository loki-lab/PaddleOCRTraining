...
For more KIE models in PaddleOCR, please refer to [KIE model zoo](../../PaddleOCR/doc/doc_en/algorithm_overview_en.md).
...
For training, evaluation and inference tutorial for KIE models, please refer to [KIE doc](../../PaddleOCR/doc/doc_en/kie_en.md).

For training, evaluation and inference tutorial for text detection models, please refer to [text detection doc](../../PaddleOCR/doc/doc_en/detection_en.md).

For training, evaluation and inference tutorial for text recognition models, please refer to [text recognition doc](../../PaddleOCR/doc/doc_en/recognition_en.md).
